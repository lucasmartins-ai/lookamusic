    ...
    <div className="timeline-editor" data-testid="timeline-editor">
      ...
      <section className="panel" aria-label="Trilha Melódica">
            ...
            return (
              <button
                ...
                style={{
                  ...
                  border: isSelected ? "2px solid #fff" : "1px solid var(--faint)",
                  borderRadius: "4px",
                  fontSize: "11px",
                  fontWeight: 600,
                  cursor: "pointer",
        ...
        {selectedNote && (
          ...
          >
            <h3>EDITAR NOTA: {midiToNoteName(selectedNote.midi)} ({selectedNote.pitch.toFixed(1)} Hz)</h3>
            <div className="controls">
            ...
            return (
              ...
              >
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <strong style={{ fontSize: "12px", letterSpacing: "0.1em" }}>{inst.toUpperCase()}</strong>
                  <button
